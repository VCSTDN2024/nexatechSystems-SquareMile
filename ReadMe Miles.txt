...
ThiContents of this document contain the following:

1. The purpose of the app 
2. How to Compile and Run the Software
3. Design Consideration
4. Utilisation of github and github actions
...
*****************************************************************************
-We utilized GitHub to coolaborate by committing, pushing, and pulling code 
